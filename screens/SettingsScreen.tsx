...
export default function SettingsScreen({ onShowInfo, onShowLeaderboard, onShowSchedule, onStartFirstSession }: Props) {
    ...
    Alert.alert(
      ...
      [
        ...
        { text: 'Clear', style: 'destructive', onPress: async () => {
          await AsyncStorage.multiRemove(['focus_history', 'streak_data']);
          Alert.alert('Done', 'Session history and streak cleared.');
        }},
      ]
    );
  };
  ...
  const handleStartFirstSession = async () => {
    await AsyncStorage.removeItem('first_session_hint_dismissed');
    onStartFirstSession();
  };
  ...
  return (
    <View style={[{flex:1, backgroundColor: c.bg}]}>
      ...
      {/* Community */}
      <View style={styles.section}>
        <Text style={[styles.sectionLabel, { color: c.textSub }]}>COMMUNITY</Text>
        ...
        >
          <View style={styles.switchRow}>
            <View style={styles.switchInfo}>
              <Text style={[styles.switchLabel, { color: c.text }]}>🏆  Streak Leaderboard</Text>
              <Text style={[styles.switchDesc, { color: c.textSub }]}>See how your streak ranks this week</Text>
            </View>
        ...
        >
          <View style={styles.switchRow}>
            <View style={styles.switchInfo}>
              <Text style={[styles.switchLabel, { color: c.text }]}>⏰  Schedule a Session</Text>
              <Text style={[styles.switchDesc, { color: c.textSub }]}>Pre-commit and get a reminder</Text>
            </View>
            <Text style={[styles.chevron, { color: c.accent }]}>›</Text>
          </View>
        </TouchableOpacity>
            ...
            {TRACKS.map(track => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  defaultTrack === track.index && { backgroundColor: `${c.accent}15` },
                ]}
              ...
              >
                ...
                <Text style={[
                  ...
                  { color: c.textMuted },
                  defaultTrack === track.index && { color: c.accent },
                ]}>
                  {track.name}
                </Text>
        ...
        <View style={[styles.card, { backgroundColor: c.card, borderColor: c.cardBorder }]}>
          <View style={styles.switchRow}>
            <View style={styles.switchInfo}>
              ...
              <Text style={[styles.switchDesc, { color: c.textSub }]}>Daily 8pm streak reminder</Text>
            </View>
            <Switch
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity
          style={[styles.card, { backgroundColor: c.card, borderColor: `${c.accent}44`, marginBottom: 10 }]}
          onPress={handleStartFirstSession}
        >
          <View style={styles.switchRow}>
            <View style={styles.switchInfo}>
              <Text style={[styles.switchLabel, { color: c.text }]}>🎯  Start Here</Text>
              <Text style={[styles.switchDesc, { color: c.textSub }]}>Restart the guided first session prompt</Text>
            </View>
            <Text style={[styles.chevron, { color: c.accent }]}>›</Text>
          </View>
        </TouchableOpacity>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.dangerCard} onPress={handleClearHistory}>
          ...
          <Text style={styles.dangerDesc}>Permanently delete all past sessions and streak</Text>
        </TouchableOpacity>
      </View>
